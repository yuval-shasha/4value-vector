...
/**
 * @class vec4stateTest
 * @brief This class is used to test the vec4state class.
 * 
 * This class is used to test the vec4state class. It contains several vec4state objects that hold different values and sizes, which are used to test the different functionalities of the vec4state class.
 */
class vec4stateTest : public testing::Test {
protected:
    /**
     * @brief defaultVector is a vector that holds the default value of x.
     * 
     */
    vec4state defaultVector;

    /**
     * @brief intVector is a vector that holds the value of the integer 0x12345678.
     * 
     */
    vec4state intVector = vec4state(0x12345678);

    /**
     * @brief longLongVector is a vector that holds the value of the long long number 0x1234567890ABCDEF.
     * 
     */
    vec4state longLongVector = vec4state(0x1234567890ABCDEF);

    /**
     * @brief stringVector is a vector that holds the value of the string "01xz11".
     * 
     */
    vec4state stringVector = vec4state("01xz11");

    /**
     * @brief bigVector is a vector that holds 0110011xzx0111zzzx0110011xzx0111zzzx0110011xzx0111zzzx0110011xzx0111zzzx0110011xzx0111zzzx0110011xzx0111zzzx.
     * 
     */
    ...
    /**
     * @brief onesVector is a vector that holds 11.
     * 
     */
    vec4state onesVector = vec4state("11");

    /**
     * @brief xThenOnesVector is a vector that holds x11.
     * 
     */
    vec4state xThenOnesVector = vec4state("x11");

    /**
     * @brief xVector is a vector that holds xx.
     * 
     */
    vec4state xVector = vec4state("xx");

    /**
     * @brief zVector is a vector that holds zz.
     * 
     */
    vec4state zVector = vec4state("zz");

    /**
     * @brief xzVector is a vector that holds xz.
     * 
     */
    vec4state xzVector = vec4state("xz");

    /**
     * @brief oneAndXVector is a vector that holds 1x.
     * 
     */
    vec4state oneAndXVector = vec4state("1x");

    /**
     * @brief oneAndZVector is a vector that holds 1z.
     * 
     */
    vec4state oneAndZVector = vec4state("1z");

    /**
     * @brief zeroAndXVector is a vector that holds 0x.
     * 
     */
    vec4state zeroAndXVector = vec4state("0x");

    /**
     * @brief zeroAndZVector is a vector that holds 0z.
     * 
     */
    vec4state zeroAndZVector = vec4state("0z");

    /**
     * @brief zeroesVector is a vector that holds 00.
     * 
     */
    vec4state zeroesVector = vec4state("00");

    /**
     * @brief xThenZeroesVector is a vector that holds z00.
     * 
     */
    vec4state zThenZeroesVector = vec4state("z00");

    /**
     * @brief negativeVector is a vector that holds the value of the negative integer -1.
     * 
     */
